...
/* Plans Test cases generated on: 2010-07-24 02:07:19 : 1279953739*/
...
class PlansControllerTestCase extends CakeTestCase {
	var $fixtures = array('app.plan', 'app.server', 'app.subdomain', 'app.account', 'app.custom_field_value', 'app.custom_field', 'app.log', 'app.staff_account', 'app.ticket_reply', 'app.ticket', 'app.mail_log');
