	<div id="contentbox"> 
        <div id="step2"> 
          ...
          <tr> 
            <td>Password:</td> 
            <td><input name="pass" type="password" class="complete" id="pass" value="lolololol" /></td> 
          </tr> 
          <tr> 
          ...
          <tr> 
            <td>Email:</td> 
            <td><input name="user" type="text" class="invalid" style="" id="email" value="Invalidemail.com" /></td> 
          </tr> 
          </table> 
    </div></div> 
    <div id="buttonbox"> 
