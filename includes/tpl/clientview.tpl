  ...
  <tr>
	...
	<table>
	  ...
	  <div id="1" style="display:none;">
		<a title="The user's account and package will remain on the system but in a cancelled state." class="tooltip"><img src="<ICONDIR>information.png" /></a> <a href="?page=users&amp;sub=search&amp;do=%ID%&amp;func=cancel">Cancel</a><br />
		<a title="Deletes all traces of the user from the system." class="tooltip"><img src="<ICONDIR>information.png" /></a> <a href="?page=users&amp;sub=search&amp;do=%ID%&amp;func=term">Terminate</a>
	  </div>
	  </td>
	  </tr>
	  </table>
